...
def get_account(index=None, id=None):
    ...
    if (
        network.show_active() in FORK_LOCAL_ENVIROMENTS
...
def get_contract(contract_name):
    ...
    Return:
        brownie.network.contract.ProjectContract: The most recently deployed verion of this contract.
    """
...
def deploy_mocks(decimals=DECIAMALS, initial_value=INITIAL_VALUE):
    account = get_account()
